    ...
    <div>
      ...
      <section className="mx-auto max-w-6xl px-6 py-16">
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {services.map((service) => (
            <div
              key={service.title}
              className="group flex flex-col rounded-2xl border border-zinc-200 bg-white p-6 shadow-[0_2px_5px_rgba(24,24,27,0.06)] transition duration-200 hover:border-zinc-300 hover:shadow-md"
            >
              ...
              <Link
                ...
                className="mt-5 inline-flex items-center gap-1 text-sm font-semibold text-red-600"
              >
                {service.cta.label}
                <svg
                  aria-hidden="true"
        ...
        <div className="mx-auto max-w-6xl">
          <div className="mb-8 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
            <div>
              ...
              <h2 className="mt-2 text-2xl font-bold text-zinc-900">
                Commercial landing pages for high-intent buyers
              </h2>
              <p className="mt-2 max-w-2xl text-sm leading-relaxed text-zinc-600">
                Some buyers are not looking for a generic service overview. They are searching for a
                concrete business or home solution. These pages give them a clearer path.
              </p>
            </div>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            {[
              ...
              >
                <h3 className="text-lg font-semibold text-zinc-900 group-hover:text-red-600">
                  {item.title}
                </h3>
      ...
      <section className="bg-red-600 px-6 py-14 text-white text-center">
        ...
        <p className="mt-2 text-red-100 text-sm">
          Every business is different. Chat with us and we&apos;ll put together the right package
          for you.
        </p>
        <a
