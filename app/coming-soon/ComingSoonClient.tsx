    ...
    icon: (
      ...
      >
        <path
          ...
          d="M4 9c4.8-4.7 11.2-4.7 16 0M7.5 12.5c2.9-2.8 6.1-2.8 9 0M11.2 16.2a1.1 1.1 0 1 1 1.6 1.6 1.1 1.1 0 0 1-1.6-1.6Z"
        />
      </svg>
    ),
  },
    ...
    icon: (
      ...
      >
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
          d="M2.5 12c1.2-3.6 4.6-6 8.8-6 4.1 0 7.5 2.4 8.7 6-1.2 3.6-4.6 6-8.7 6-4.2 0-7.6-2.4-8.8-6Z"
        />
        ...
        <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-center lg:gap-16">
          ...
          <div className="text-center lg:text-left">
            ...
            <p className="mx-auto mt-4 max-w-lg text-base leading-relaxed text-zinc-400 lg:mx-0">
              We&apos;re making quick improvements behind the scenes. Your order, pricing, and stock
              questions don&apos;t have to wait &mdash; reach us directly on WhatsApp and our team
            ...
            <div className="grid grid-cols-2 gap-3">
              {FEATURES.map((item) => (
                <div key={item.label} className="rounded-xl bg-white/5 p-3 text-center">
                  <div className="mb-1 flex items-center justify-center text-red-400">
                    {item.icon}
                  </div>
