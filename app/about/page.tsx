...
const values = [
  {
    ...
    description:
      'Every decision we make starts with you. We source products that deliver real value and back every sale with personal support.',
    icon: (
      <svg
  ...
  },
  {
    ...
    description:
      'We stock only authentic, quality-assured tech from trusted brands - no counterfeits, no compromises.',
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
  ...
  },
  {
    title: 'Fast & Simple',
    description:
      'Order in seconds via WhatsApp. No complicated checkouts - just chat, confirm, and we handle the rest.',
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
  ...
  },
  {
    title: 'Expert Advice',
    description:
      'Not sure what to buy? Our team knows tech inside and out. We help you pick the right product for your budget and needs.',
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
    ...
    <div>
      ...
      <section className="mx-auto max-w-3xl px-6 py-16">
        ...
        <div className="space-y-4 text-sm leading-7 text-zinc-600">
          <p>
            Cansan Solutions was founded with a simple belief: everyone deserves access to quality
            technology at fair prices, with real support behind every purchase. We started as a
            small operation helping friends and family source the right devices, and grew into a
            full-service tech retailer serving customers across Zimbabwe.
          </p>
          <p>
            Today, we carry everything from smartphones and laptops to networking equipment, UPS
            power backup systems, and audio gear. Our catalogue spans the world&apos;s leading
            brands - Samsung, Apple, HP, Dell, TP-Link, Sony, and more - all sourced through
            verified supply chains.
          </p>
          <p>
            What sets us apart is how easy we make it to buy. Browse our catalogue, add items to
            your cart, and send us a WhatsApp message - we&apos;ll confirm availability, finalise
            pricing, and arrange delivery or collection. No complicated forms, no hidden fees.
          </p>
        </div>
      </section>
      ...
      <section className="px-6 py-16 text-center">
        ...
        <p className="mt-2 text-sm text-zinc-500">
          Browse our full range or get in touch - we&apos;re here to help.
        </p>
