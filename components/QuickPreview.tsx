      ...
      {product && (
        <>
          ...
          <motion.div
            ...
            className="fixed inset-x-4 top-1/2 z-50 max-w-2xl w-full mx-auto -translate-y-1/2 bg-white rounded-2xl shadow-2xl overflow-hidden"
            style={{ left: '50%', transform: 'translate(-50%, -50%)' }}
          >
            <div className="grid sm:grid-cols-2">
              {/* Image pane */}
              <div className="relative flex items-center justify-center bg-gradient-to-br from-zinc-50 to-zinc-100 p-8 min-h-[240px]">
                <img
                  src={product.image}
                  alt={product.name}
              ...
              <div className="flex flex-col gap-3 p-6">
                ...
                <button
                  onClick={onClose}
                  className="absolute top-4 right-4 flex h-8 w-8 items-center justify-center rounded-full bg-white/80 shadow transition hover:bg-zinc-100"
                  aria-label="Close"
                >
                ...
                <div className="mt-auto flex flex-col gap-2 pt-1">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="flex items-center justify-center gap-2 rounded-full border border-green-600 py-2.5 text-sm font-semibold text-green-700 transition hover:bg-green-50"
                  >
