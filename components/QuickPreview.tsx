      ...
      {product && (
        <>
          ...
          <motion.div
            ...
            className="fixed inset-x-3 bottom-3 top-auto z-50 mx-auto w-auto overflow-hidden rounded-2xl bg-white shadow-2xl max-h-[85dvh] sm:inset-x-4 sm:top-1/2 sm:w-full sm:max-w-2xl sm:-translate-y-1/2 sm:bottom-auto"
          ...
          >
            <div className="grid max-h-[85dvh] overflow-y-auto sm:grid-cols-2 sm:overflow-hidden">
              ...
              <div className="relative flex min-h-[220px] items-center justify-center bg-gradient-to-br from-zinc-50 to-zinc-100 p-6 sm:min-h-[240px] sm:p-8">
                ...
                {product.condition && (
                  <span className={`absolute top-4 left-4 rounded-full px-2.5 py-1 text-[11px] font-bold ${CONDITION_LABEL[product.condition]?.color ?? ''}`}>
              ...
              <div className="flex flex-col gap-3 p-5 sm:p-6">
                ...
                <button
                  onClick={onClose}
                  className="absolute right-4 top-4 flex h-9 w-9 items-center justify-center rounded-full bg-white/85 shadow transition hover:bg-zinc-100"
                  aria-label="Close"
                >
                ...
                <div className="flex items-baseline gap-2 pt-1">
                  ...
                  {qtyInCart > 0 && (
                    <span className="text-xs font-semibold text-green-600">{qtyInCart} in cart</span>
                  )}
                </div>
                <p className="text-[11px] text-zinc-400">Price indicative — confirm via WhatsApp.</p>
                ...
                <div className="mt-auto flex flex-col gap-2 pt-1">
                  <motion.button
                    ...
                    className={`flex min-h-11 items-center justify-center gap-2 rounded-full py-2.5 text-sm font-semibold transition-all
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="flex min-h-11 items-center justify-center gap-2 rounded-full border border-green-600 py-2.5 text-sm font-semibold text-green-700 transition hover:bg-green-50"
                  >
                  ...
                  <Link
                    ...
                    onClick={onClose}
                    className="text-center text-xs font-medium text-zinc-400 hover:text-zinc-700 transition-colors"
                  >
                    View full details →
                  </Link>
                </div>
