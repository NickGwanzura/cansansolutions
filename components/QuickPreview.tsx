          ...
          >
            <div className="grid max-h-[85dvh] overflow-y-auto sm:grid-cols-2 sm:overflow-hidden">
              ...
              <div className="relative flex min-h-[220px] items-center justify-center bg-gradient-to-br from-zinc-50 to-zinc-100 p-6 sm:min-h-[240px] sm:p-8">
                ...
                {product.condition && (
                  <span className={`absolute left-4 top-4 inline-flex min-h-9 items-center rounded-full px-3 py-1 text-xs font-bold ${CONDITION_LABEL[product.condition]?.color ?? ''}`}>
              ...
              <div className="flex flex-col gap-3 p-5 sm:p-6">
                ...
                {isBundle && product.bundleItems.length > 0 && (
                  <div className="rounded-2xl border border-zinc-200 bg-zinc-50 p-3">
                    <p className="text-xs font-semibold uppercase tracking-wide text-zinc-600">Bundle includes</p>
                ...
                <div className="flex items-baseline gap-2 pt-1">
                  ...
                  {qtyInCart > 0 && (
                    <span className="text-sm font-semibold text-green-600">{qtyInCart} in cart</span>
                  )}
                </div>
