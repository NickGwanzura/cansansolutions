        ...
        <div className="grid gap-10 lg:grid-cols-4">
          ...
          <div>
            ...
            <p className="mt-5 text-sm leading-relaxed text-zinc-600">
              Zimbabwe&apos;s trusted tech retailer. We supply genuine laptops, networking gear, CCTV, and accessories with
              WhatsApp-simple ordering and warranty-backed support.
            </p>
          ...
          <div className="space-y-3 lg:hidden">
            <details className="rounded-2xl border border-zinc-200 bg-white px-4 py-3">
              <summary className="cursor-pointer list-none text-sm font-semibold text-zinc-900">Top Categories</summary>
              <ul className="mt-3 grid grid-cols-2 gap-3">
                {categoryLinks.map(({ href, label }) => (
                  <li key={href}>
                    <Link href={href} className="text-sm text-zinc-600 transition hover:text-red-700">
                      {label}
                    </Link>
                  </li>
                ))}
            ...
            <details className="rounded-2xl border border-zinc-200 bg-white px-4 py-3">
              <summary className="cursor-pointer list-none text-sm font-semibold text-zinc-900">Help &amp; Support</summary>
          ...
          <div className="hidden lg:block">
            <h3 className="mb-4 text-xs font-bold uppercase tracking-widest text-zinc-900">Top Categories</h3>
          ...
          <div className="hidden lg:block">
            <h3 className="mb-4 text-xs font-bold uppercase tracking-widest text-zinc-900">Help &amp; Support</h3>
            <ul className="space-y-2.5">
              {supportLinks.map(({ href, label }) => (
                <li key={href}>
                  <Link href={href} className="text-sm text-zinc-600 transition hover:text-red-700">
          ...
          {/* We're here to help */}
          <div>
            <h3 className="mb-4 text-xs font-bold uppercase tracking-widest text-zinc-900">We&apos;re Here to Help</h3>
            <p className="text-sm text-zinc-600">We&apos;re available by WhatsApp, phone, and email.</p>

            <div className="mt-4">
              <p className="text-sm font-semibold text-zinc-900">WhatsApp &amp; Calls</p>
              <p className="mt-1 text-sm text-zinc-600">Mon&ndash;Fri 8am&ndash;6pm &middot; Sat 9am&ndash;4pm</p>
              <a href={`https://wa.me/${WA_NUMBER}`} target="_blank" rel="noreferrer" className="mt-1 inline-block text-sm font-medium text-red-700 hover:text-red-800">
                {SITE_PHONE}
              </a>
            </div>
            ...
            <div className="mt-4">
              ...
              <a href={`mailto:${SITE_EMAIL}`} className="mt-1 inline-block text-sm text-zinc-600 hover:text-red-700">
                {SITE_EMAIL}
              </a>
            </div>
      ...
      <div className="border-t border-zinc-200">
        <div className="mx-auto max-w-7xl px-6 py-5">
          <div className="flex flex-col items-center gap-3 text-xs text-zinc-500 sm:flex-row sm:justify-between">
            ...
            >
              Built by SPIRITUSGLOBAL.TECH
            </a>

            <div className="flex items-center gap-4">
              <Link href="/about" className="transition hover:text-zinc-800">About</Link>
              <Link href="/contact" className="transition hover:text-zinc-800">Contact</Link>
            </div>
          </div>
        </div>
      </div>
