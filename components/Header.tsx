    ...
    <>
      ...
      <header className="sticky top-0 z-40 w-full border-b border-zinc-200 bg-white shadow-[0_8px_24px_-18px_rgba(24,24,27,0.16)]">
        ...
        <div className="mx-auto flex h-[4.75rem] max-w-7xl items-center gap-4 px-4 sm:px-6">
          <Link href="/" className="group shrink-0 transition focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-zinc-950" aria-label="Cansan Electronics">
          ...
          <form onSubmit={handleSearch} className="hidden flex-1 max-w-2xl md:block">
            <div className="relative">
              <svg aria-hidden="true" className="absolute left-4 top-1/2 h-4 w-4 -translate-y-1/2 text-zinc-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
          ...
          <div className="ml-auto flex items-center gap-2">
            ...
            <div className="hidden items-center gap-2 rounded-lg border border-zinc-200 bg-zinc-50 px-3 py-2 text-xs text-zinc-700 lg:flex">
              <svg aria-hidden="true" className="h-4 w-4 shrink-0 text-red-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M12 21s7-5.2 7-12A7 7 0 1 0 5 9c0 6.8 7 12 7 12Z" />
                <circle cx="12" cy="9" r="2" />
              </svg>
              <span><span className="block text-[10px] leading-none text-zinc-400">Deliver to</span><strong className="font-semibold">Harare</strong></span>
            </div>
            <button
                ...
                return (
                  <Link
                    ...
                    className={`flex min-h-11 items-center rounded-lg px-3 py-3 text-sm font-medium transition ${
                      active ? 'bg-red-50 text-red-700' : 'text-zinc-600 hover:bg-zinc-50 hover:text-zinc-950'
                    }`}
                  >
                    {label}
                  </Link>
            ...
            <nav className="flex flex-col gap-1">
              <Link
                ...
                className={`rounded-lg px-3 py-2.5 text-sm font-medium transition ${
                  pathname.startsWith('/products') ? 'bg-red-50 text-red-700' : 'text-zinc-700 hover:bg-zinc-50'
                }`}
              >
                All Products
              </Link>
